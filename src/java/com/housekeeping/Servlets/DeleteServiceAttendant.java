 ...
 */
@MultipartConfig
public class DeleteServiceAttendant extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           int id=Integer.parseInt( request.getParameter("del_sa_id"));
           ServiceDao dao=new ServiceDao(ConnectionProvider.getConnection());
           Service_attendant sa=new Service_attendant(id);
           boolean ans=dao.deleteServiceAttendant(sa);
            if(ans){
                out.println("deleted");
            }
            else{
