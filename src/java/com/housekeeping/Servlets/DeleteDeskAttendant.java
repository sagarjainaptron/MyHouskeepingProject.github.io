 ...
 */
@MultipartConfig
public class DeleteDeskAttendant extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            int id=Integer.parseInt( request.getParameter("del_da_id"));
           DeskDao dao=new DeskDao(ConnectionProvider.getConnection());
           Desk_attendant sa=new Desk_attendant(id);
           boolean ans=dao.deleteDeskAttendant(sa);
            if(ans){
                out.println("deleted");
            }
            else{
