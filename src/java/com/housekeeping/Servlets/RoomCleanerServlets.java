 ...
 */
@MultipartConfig
public class RoomCleanerServlets extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int floorNo=Integer.parseInt(request.getParameter("cfn"));
            String roomNo=request.getParameter("crn");
            String name=request.getParameter("cn");
            String status=request.getParameter("cs");
            
            Floor floor=new Floor(floorNo, roomNo, name, status);
            FloorDao dao=new FloorDao(ConnectionProvider.getConnection());
            if(dao.insertDatewiseCleanerRecords(floor)){
                   out.println("done");
              }else{
                  out.println("error");
              }
