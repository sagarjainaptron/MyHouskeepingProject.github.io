<%-- 
    Document   : cleanerData
    Created on : Jun 24, 2020, 4:21:41 PM
    Author     : hp world
--%>
...
<%
  Staff_update staff_update=(Staff_update)session.getAttribute("currentuser");
...
<html>
    <head>
        ...
        <title><%= staff_update.getStff_name()%> Welcome Page</title>
    ...
    <body style="background-color: blue; color: white">
        ...
        <div class="container">
             ...
             <div class="container-fluid mt-4">
                ...
                <button data-toggle="modal" data-target="#cleaner-attendant-updates">Click here to update the details</button>
        ...
        <!-- Modal -->
<div class="modal fade" id="cleaner-attendant-updates" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form action="RoomCleanerServlets" method="POST" id="update-cleaner" >
           
              <div class="form-group">
                  <input name="cfn" type="text" placeholder="Floor No." class="form-control"/>
              </div>
              <div class="form-group">
                  <input type="text" name="crn" placeholder="Room No." class="form-control" placeholder="Room No."/>
              </div>
              <div class="form-group">
                  <input name="cn" type="text" value="<%= staff_update.getStff_name()%>" class="form-control"/>
              </div>
              <br>
              <div class="form-group">
                  <input name="cs" type="text" placeholder="Status" class="form-control"/>
                  <small class="form-text text-danger ml-2">Type cleaned if work is done otherwise dirty...</small>
              </div>
...
<script>
    $(document).ready(function (){
       $('#update-cleaner') .on('submit',function (event){
           event.preventDefault();
           var form = new FormData(this);
           $.ajax({
               url: "RoomCleanerServlets",
               data: form,
               type: 'POST',
